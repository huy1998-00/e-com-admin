...
const Conversations = ({ data }) => {
  ...
  //fetch data client
  // useEffect(() => {
  //   const Clientid = data.members.find((m) => m !== currentUser._id);
  //   const getUser = async () => {
  //     const request = await AuthAPI.clientInfo(Clientid);
  ...
  return (
    <div className="border-y border-slate-200 flex items-center py-4 cursor-pointer hover:bg-gray-400 m-2">
      <img
